...
- `/api/chat` — NOVA ke chat replies (Grok AI se)
...
2. **xAI (Grok) API key**: https://console.x.ai → API Keys → "Create API Key"
...
- Gmail: free
- xAI (Grok) API: sirf jitna use hoga utna hi charge — chat messages ke liye typically paise ke hisaab se bahut kam (paisa dollars mein nahi, cents mein sochiye per sau messages)
